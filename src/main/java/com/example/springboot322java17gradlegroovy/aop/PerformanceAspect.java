package com.example.springboot322java17gradlegroovy.aop;
...
public class PerformanceAspect {
    @Pointcut("@annotation(com.example.springboot322java17gradlegroovy.annotation.RunningTime)")
    private void enableRunningTime() {}
    @Pointcut("execution(* com.example.springboot322java17gradlegroovy..*.*(..))")
    private void cut() {}
